    ...
    <div className="project-post">
      <Button variant="light" onClick={handleShow}>
        <Card>
          {displayWikiInfo && (
            <Card.Title>
              <Link to={"/wiki/" + change.wikiID}>{change.wikiTitle}</Link>
            </Card.Title>
          )}
          <Card.Body>
            <Link to={"/account/" + change.userID}>{change.user_name}</Link>
      ...
      <Modal show={show} onHide={handleClose} size="lg">
        ...
        <Modal.Body>
          <Card.Body>
            <Link to={"/account/" + change.userID}>{change.user_name}</Link>{" "}
            made a change to{" "}
            <Link to={"/wiki/" + change.wikiID}>Wiki: {change.wikiTitle}</Link>{" "}
