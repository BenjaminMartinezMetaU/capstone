...
export default function SearchResults({ searchResults }) {
    ...
    return (
        <div className='resultsPage'>
            ...
            {/* Results display */ }
            {searchResults.results.length == 0 ? <div className='not-found'>No results found</div> : null}
            {
                searchSortOption === "newest" && searchFilterOptions.User &&
            ...
            {   searchSortOption === "newest" && searchFilterOptions.Project &&
            ...
            {
                searchSortOption === "upvotes" && searchFilterOptions.User &&
            ...
            {   searchSortOption === "upvotes" && searchFilterOptions.Project &&
